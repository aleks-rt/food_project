...
FORMAT_INSTRUCTIONS = """
Форматируй ответ ТОЛЬКО простым текстом с эмодзи — никакого HTML, никакого markdown (никаких **, ##, <b>, <i> и т.д.).
Используй эмодзи как визуальные заголовки. Таблицы заменяй списком "Имя — Xг".
"""
